"""
Build Item Table CSV rows (ITM_CD, ITM_NM, ITM_TYP, MAX_LOT_UNIT_QTY) from dbo.OITM_TMP (SAP B1).

ITM_TYP / MAX_LOT_UNIT_QTY are always NULL (blank in CSV). Column names are resolved like other SAP staging loaders.
"""
...
def fetch_item_table_rows_from_sqlserver(pyodbc_conn) -> List[Tuple[Any, Any, Any, Any]]:
    ...
    SELECT DISTINCT
        ...
        {nm_sql} AS ITM_NM,
        CAST(NULL AS NVARCHAR(64)) AS ITM_TYP,
